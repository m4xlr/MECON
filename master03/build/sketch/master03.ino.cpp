#include <Arduino.h>
#line 1 "/Users/max/Documents/LIMA MAKERS/CLIENTES/LA FOLIE/RELOAD/DIEGO/master03/master03.ino"
// * CODIGO MASTER 05
#include <Wire.h>
...
//* VOID DE ORDENES
#line 45 "/Users/max/Documents/LIMA MAKERS/CLIENTES/LA FOLIE/RELOAD/DIEGO/master03/master03.ino"
void mandarPasos(const int a[][motores]);
#line 87 "/Users/max/Documents/LIMA MAKERS/CLIENTES/LA FOLIE/RELOAD/DIEGO/master03/master03.ino"
void setup();
#line 118 "/Users/max/Documents/LIMA MAKERS/CLIENTES/LA FOLIE/RELOAD/DIEGO/master03/master03.ino"
void loop();
#line 45 "/Users/max/Documents/LIMA MAKERS/CLIENTES/LA FOLIE/RELOAD/DIEGO/master03/master03.ino"
void mandarPasos(const int a[][motores]){
    int ok = 0;
...
void setup(){
    ...
    for (int i = 0; i < motores; i++) //inicia verificacion para cada motor
    {
        while (listo =!1)
        {
            Wire.requestFrom(i+8,1);
            delay(200);//espera a que responda el slave
            ...
            delay(200); //Tiempo de espera para volver a solicitar
        }

        Serial.print("Motor"); //NOTIFICACION A SERIAL [DEV]
        Serial.print(i+1);
        Serial.print("listo!");
