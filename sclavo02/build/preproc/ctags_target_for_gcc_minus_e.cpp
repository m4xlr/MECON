# 1 "/Users/max/Documents/LIMA MAKERS/CLIENTES/LA FOLIE/RELOAD/DIEGO/sclavo02/sclavo02.ino"
# 2 "/Users/max/Documents/LIMA MAKERS/CLIENTES/LA FOLIE/RELOAD/DIEGO/sclavo02/sclavo02.ino" 2
# 3 "/Users/max/Documents/LIMA MAKERS/CLIENTES/LA FOLIE/RELOAD/DIEGO/sclavo02/sclavo02.ino" 2
...
void setup() {
   ...
   pinMode(12 /* Define Pin 12 connectado como Switch FIN DE CARRERA (MicroSwitch)*/, 0x2); //Configuracion pin FIN DE CARRERA
...
// Start Homing procedure of Stepper Motor at startup
  ...
  while (digitalRead(12 /* Define Pin 12 connectado como Switch FIN DE CARRERA (MicroSwitch)*/)) { // Make the Stepper move CCW until the switch is activated   
  ...
  while (!digitalRead(12 /* Define Pin 12 connectado como Switch FIN DE CARRERA (MicroSwitch)*/)) { // Make the Stepper move CW until the switch is deactivated
